...
VALUES
(1, '01311100', 'Av. Paulista', 1000, 'Bela Vista', 'Conj. 101', 1),
(2, '07190100', 'Rod. Hélio Smidt', 1200, 'Aeroporto', 'Terminal 2', 2),
(3, '22070010', 'Rua Prudente de Morais', 500, 'Ipanema', NULL, 3),
(4, '05407000', 'Rua Teodoro Sampaio', 2300, 'Pinheiros', 'Apto. 50', 1);

-- ------------------------------------------------------------
-- 4. INSERÇÃO DE AGÊNCIAS
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 5. VEÍCULOS (Marca, Modelo, Categoria, Veiculo)
-- ------------------------------------------------------------
...
INSERT IGNORE INTO Veiculo (id_Veiculo, Frota, Placa, Km_Rodado, StatusVeiculo,
                             fk_Categoria_id_Categoria, fk_Marca_id_Marca, fk_Modelo_id_Modelo)
VALUES
...
INSERT IGNORE INTO Usuario_ (id_Usuario, Email, Nome_Completo, Senha, Data_Nasc, CPF, CNH,
                              Cargo, Salario, Pontuacao_Reputacao, fk_Funcao_id_Funcao,
                              fk_Endereco_id, id_Cliente, id_Funcionario, id_Admin, tipo_perfil)
VALUES
(1, 'roberto.admin@locarsdrive.com', 'Roberto Campos (Admin)', '$2b$12$...', '1990-05-15',
 '12345678901', 'ABC12345678', 'Administrador Geral', 10000.00, 5.0,
 4, 4, 1, 1, 1, 'misto'),

(2, 'joao.cliente@mail.com', 'João Silva', '$2b$12$...', '1985-11-20',
 '98765432109', 'DEF87654321', NULL, 0.00, 4.5,
 1, NULL, 2, 0, 0, 'alugador'),

(3, 'maria.func@mail.com', 'Maria Souza (Func)', '$2b$12$...', '1995-03-10',
 '45612378900', 'GHI09876543', 'Atendente', 3000.00, 5.0,
 2, NULL, 0, 2, 0, 'locador');

-- ------------------------------------------------------------
-- 7. ALUGUEL E RELACIONADAS
-- ------------------------------------------------------------

INSERT IGNORE INTO aluguel (id_aluguel, fk_usuario_id, fk_veiculo_id,
                            data_retirada, data_devolucao_prevista, data_devolucao_real,
                            status, valor_diaria, valor_total_previsto)
VALUES
...
INSERT IGNORE INTO vistoria (id_vistoria,fk_aluguel_id,tipo,nivel_combustivel,
                             quilometragem,avarias_json,data_vistoria)
VALUES
