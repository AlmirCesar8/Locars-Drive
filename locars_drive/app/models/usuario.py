...
class Usuario(UserMixin, db.Model):
    ...
    # 2. FK para Funcao (conforme DDL, opcional para usuário não-funcionário)
    fk_Funcao_id_Funcao = db.Column(db.Integer, ForeignKey('Funcao.id_Funcao'), nullable=True)
    
    # 3. FK para Permissao (conforme DDL, opcional)
    # fk_Permissao_id_Permissoes = db.Column(db.Integer, ForeignKey('Permissao.id_Permissoes'), nullable=True)
